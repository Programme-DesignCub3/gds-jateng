  ...
  <AppLayout>
    ...
    <div class="container mb-10 max-w-xl">
      ...
      >
        ...
        <div>
          <InputLabel for="competition" required value="Kompetisi yang Diikuti" />
        ...
        <div class="gap-3">
          ...
          />
          <InputError class="mt-2" :message="form.errors.judulVideo" />
        </div>
        ...
        <div class="grid gap-3">
          ...
          <Textarea
            ...
            class="min-h-[9.5rem]"
          />
          <InputError class="mt-2" :message="form.errors.videoDescription" />
        </div>
